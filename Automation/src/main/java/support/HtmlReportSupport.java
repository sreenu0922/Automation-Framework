...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport() throws Exception {
		...
		try {
			...
			writer.write("<th>&nbsp;browserType&nbsp;:</th> ");
			writer.write("<th>"
					+ configProps.getProperty("browserTypeType")+ "</th> ");
			writer.write("</tr> ");
	...
	@SuppressWarnings("rawtypes")
	public static void createHtmlSummaryReport(String browserType, String Url) throws Exception {
...
//			TestEngine.FailNum = TestEngine.FailNum + 1;
	...
	public static void testHeader(String testName, String browserType) {
		Writer writer = null;
		try {
			strTestName = testName;
			File file = new File(TestEngine.filePath() +"/"+strTestName+ "_Results_"
