...
public class ActionEngine extends TestEngine {
	...
	public static boolean ScrollToElement(By locator, String locatorName) throws Throwable {
		 ...
		 * use ActionClass
		 * 
		 * Tab(By Locator) AND Tab(using coordinates) -- Vinay LongpressTab (By
		 * Locator)AND (using Coordinates -- Vinay DoubleTab -- Jagadishwar
		 * ScrollToElement -- Jagadishwar Swipe up -- Srinivas N Swipe down -- Srinivas
		 * N Swipe left -- Srinivas N Swipe Right -- Srinivas N sendKey -- Ranga
		 * isElementDisplay -- Pravalika WaitforElement -- Bhavya draganddrop
		 * --Pravalika switchWindowByTitle --Sangeetha clikcOnAlert -- Sangeetha
		 */
