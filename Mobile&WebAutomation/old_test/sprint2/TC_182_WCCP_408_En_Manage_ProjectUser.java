...
public class TC_182_WCCP_408_En_Manage_ProjectUser extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Sprint");
	
	@Test(dataProvider = "testData")
	public void TC182_WCCP_408_En_Manage_ProjectUser(String emailid_sa, String passwd, String emailid_en,
		...
		try{	
			...
			Reporter.SuccessReport("TC182_WCCP_408_En_Manage_ProjectUser", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC182_WCCP_408_En_Manage_ProjectUser", "Failed");
			e.printStackTrace();
		}
	}
	    ...
	    return new Object[][] { 
	    		{
	    			...
	    			"Verify TC182_WCCP_408_En_Manage_ProjectUser"
	    		}};
	}
