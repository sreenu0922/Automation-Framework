...
public class TC_171_Detail_Project_Dashboard_Project_Cm extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Sprint");
	
	@Test(dataProvider = "testData")
	public void TC171_Detail_Project_Dashboard_Project_Cm(String emailid, String passwd, String project, String newprojectName,
		...
		try{	
			...
			Reporter.SuccessReport("TC171_Detail_Project_Dashboard_Project_Cm", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC171_Detail_Project_Dashboard_Project_Cm", "Failed");
			e.printStackTrace();
		}
	}
