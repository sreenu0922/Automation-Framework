...
public class TC_84_Detail_Site_Sub_Page_Project extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Setting");
	
	@Test(dataProvider = "testData")
	public void TC84_Detail_Site_Sub_Page_Project(String emailid, String passwd, String project, String newprojectName,
		...
		try{	
			...
			savePage();
			workflow(choice, "Testing Details");
			Reporter.SuccessReport("TC84_Detail_Site_Sub_Page_Project", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC84_Detail_Site_Sub_Page_Project", "Failed");
			e.printStackTrace();
		}
	}
