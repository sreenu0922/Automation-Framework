...
public class TC_87_SEO_Page_News_Page_Name extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Setting");
	
	@Test(dataProvider = "testData")
	public void TC87_SEO_Page_News_Page_Name(String emailid, String passwd, String project, String newname,
		...
		try{
			...
			Reporter.SuccessReport("TC87_SEO_Page_News_Page_Name", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC87_SEO_Page_News_Page_Name", "Failed");
			e.printStackTrace();
		}
	}
