...
public class TC_126_Verify_Project_Sub_Page_Version_NewPage_Cm extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Sprint");
	
	@Test(dataProvider = "testData")
	public void TC126_Verify_Project_Sub_Page_Version_NewPage_Cm(String emailid, String passwd, String projectname,
		...
		try{
			...
			Reporter.SuccessReport("TC126_Verify_Project_Sub_Page_Version_NewPage_Cm", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC126_Verify_Project_Sub_Page_Version_NewPage_Cm", "Failed");
			e.printStackTrace();
		}
	}
