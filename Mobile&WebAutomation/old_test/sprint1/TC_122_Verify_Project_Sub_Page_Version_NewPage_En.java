...
public class TC_122_Verify_Project_Sub_Page_Version_NewPage_En extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Sprint");
	
	@Test(dataProvider = "testData")
	public void TC122_Verify_Project_Sub_Page_Version_NewPage_En(String emailid, String passwd, String projectname,
		...
		try{
			...
			Reporter.SuccessReport("TC122_Verify_Project_Sub_Page_Version_NewPage_En", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC122_Verify_Project_Sub_Page_Version_NewPage_En", "Failed");
			e.printStackTrace();
		}
	}
