...
public class TC_132_Location_Project_Sub_Page_Location_Cm extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Sprint");
	
	@Test(dataProvider = "testData")
	public void TC132_Location_Project_Sub_Page_Location_Cm(String emailid, String passwd, String project,
		...
		try{
			...
			Reporter.SuccessReport("TC132_Location_Project_Sub_Page_Location_Cm", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC132_Location_Project_Sub_Page_Location_Cm", "Failed");
			e.printStackTrace();
		}
	}
	    ...
	    return new Object[][] { 
	    		{
	    			...
	    			"Verify Authoring/Page/Project_Sub_Page/Location by Consultation Manager"
	    		}};
	}
}
