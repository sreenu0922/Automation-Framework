...
public class TC_134_Verify_Project_Sub_Page_Version_Approve_Cm extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Sprint");
	
	@Test(dataProvider = "testData")
	public void TC134_Verify_Project_Sub_Page_Version_Approve_Cm(String emailid, String passwd, String project, 
		...
		try{
			...
			navigateToSetting();
			approveVersion();
			Reporter.SuccessReport("TC134_Verify_Project_Sub_Page_Version_Approve_Cm", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC134_Verify_Project_Sub_Page_Version_Approve_Cm", "Failed");
			e.printStackTrace();
		}
	}
