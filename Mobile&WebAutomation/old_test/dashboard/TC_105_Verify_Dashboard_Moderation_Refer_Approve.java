...
public class TC_105_Verify_Dashboard_Moderation_Refer_Approve extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Dashboard");
	
	@Test(dataProvider = "testData")
	public void TC105_Verify_Dashboard_Moderation_Refer_Approve(String emailid, String passwd, String projecttoaddcomment, 
		...
		try{	
			...
			approveReviewComment(commentid, projectcomment);
			Reporter.SuccessReport("TC105_Verify_Dashboard_Moderation_Refer_Approve", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC105_Verify_Dashboard_Moderation_Refer_Approve", "Failed");
			e.printStackTrace();
		}
	}
	    ...
	    return new Object[][] { 
	    		{
	    			...
	    			"Verify Dashboard_Moderation_Refer_Approve Options"
	    		}};
	}
