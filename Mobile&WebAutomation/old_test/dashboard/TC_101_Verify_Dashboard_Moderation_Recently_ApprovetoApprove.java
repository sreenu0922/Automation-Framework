...
public class TC_101_Verify_Dashboard_Moderation_Recently_ApprovetoApprove extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Dashboard");
	
	@Test(dataProvider = "testData")
	public void TC101_Verify_Dashboard_Moderation_Recently_ApprovetoApprove(String emailid, String passwd, String projecttoaddcomment, 
		...
		try{	
			...
			Reporter.SuccessReport("TC101_Verify_Dashboard_Moderation_Recently_ApprovetoApprove", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC101_Verify_Dashboard_Moderation_Recently_ApprovetoApprove", "Failed");
			e.printStackTrace();
		}
	}
	    ...
	    return new Object[][] { 
	    		{
	    			...
	    			"Verify Dashboard_Moderation_Recent_ApprovetoApprove Options"
	    		}};
	}
