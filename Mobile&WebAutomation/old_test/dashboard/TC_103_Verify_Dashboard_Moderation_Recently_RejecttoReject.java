...
public class TC_103_Verify_Dashboard_Moderation_Recently_RejecttoReject extends HelperClass {
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"Test Data - Dashboard");
	
	@Test(dataProvider = "testData")
	public void TC103_Verify_Dashboard_Moderation_Recently_RejecttoReject(String emailid, String passwd, String projecttoaddcomment, 
		...
		try{	
			...
			Reporter.SuccessReport("TC103_Verify_Dashboard_Moderation_Recently_RejecttoReject", "Passed");
		}catch(Exception e){
			Reporter.failureReport("TC103_Verify_Dashboard_Moderation_Recently_RejecttoReject", "Failed");
			e.printStackTrace();
		}
	}
	    ...
	    return new Object[][] { 
	    		{
	    			...
	    			"Verify Dashboard_Moderation_Recent_RejecttoReject Options"
	    		}};
	}
